...
def blit_all(food_pos):
    ...
    global blacktail, body, fruit, bscore2, game
    ...
    seq_maxiscore = (b_maxiscore, (300, 0))
    b_score2 = (bscore2, (300, 0))
    ...
    for surface in (bfruit, btext, b_score2, bscore, seq_maxiscore):
